...
from vllm_fl.kv_cache.ascend.kv_cache_interface import AscendSlidingWindowMLASpec
...
def _get_ascend_dsa_backend():
    ...
    from vllm_fl.attention.ascend.dsa_v1 import AscendDSABackend
...
def _dsv4_block_sizes():
    ...
    from vllm_fl.attention.ascend.dsa_layer import DSV4_BLOCK_SIZES
