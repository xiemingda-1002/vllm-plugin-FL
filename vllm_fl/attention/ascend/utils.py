...
from vllm_fl.attention.ascend.attention import _FIA_TND_LARGE_HEAD_FALLBACK_HEAD_SIZE as FIA_TND_LARGE_HEAD_FALLBACK_HEAD_SIZE
...
from vllm_fl.attention.ascend.kvcomp import KVCompMetaData
