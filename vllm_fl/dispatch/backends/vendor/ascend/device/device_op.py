...
from vllm_fl.dispatch.backends.vendor.ascend.impl import attention as device_utils
from vllm_fl.dispatch.backends.vendor.ascend.device.mxfp_compat import (
    FLOAT8_E8M0FNU_DTYPE,
    QUANT_DTYPES,
    SCALE_DTYPES,
)
from vllm_fl.dispatch.backends.vendor.ascend.ops.triton.fla.chunk_scaled_dot_kkt import chunk_scaled_dot_kkt_fwd_kernel
from vllm_fl.dispatch.backends.vendor.ascend.ops.triton.fla.solve_tril import solve_tril_16x16_kernel
from vllm_fl.dispatch.backends.vendor.ascend.ops.triton.fused_gdn_gating import fused_gdn_gating_patch
from vllm_fl.dispatch.backends.vendor.ascend.impl.quantization.quant_type import QuantType
from vllm_fl.dispatch.backends.vendor.ascend.dsa_compat import AscendDeviceType, get_ascend_device_type

DSA_COMPRESSOR_SLOT_MAPPING_FLAT = 1
DSA_COMPRESSOR_SLOT_MAPPING_BLOCK_OFFSET = 2

if HAS_TRITON:
    from vllm_fl.dispatch.backends.vendor.ascend.ops.triton.rms_norm import triton_q_rms  # noqa: F811
else:
...
class BaseDeviceAdaptor:
    ...
    def mla_preprocess_only_decode(atten_obj, hidden_states, kv_cache, attn_metadata):
        ...
        DecodeMLAPreprocessResult = namedtuple("DecodeMLAPreprocessResult", "q_nope q_pe k_nope k_pe dequant_scale_q_nope", defaults=[None])
