...
from vllm_fl.dispatch.backends.vendor.ascend.core.kv_cache_interface import AscendSlidingWindowMLASpec
from vllm_fl.dispatch.backends.vendor.ascend.ops.dsa import AscendDeepseekSparseAttention, DSAModules
from vllm_fl.dispatch.backends.vendor.ascend.ops.rope_dsv4 import ComplexExpRotaryEmbedding
from vllm_fl.dispatch.backends.vendor.ascend.impl.muls_add import muls_add_triton
...
def _get_ascend_dsa_backend():
    ...
    from vllm_fl.dispatch.backends.vendor.ascend.attention.dsa_v1 import AscendDSABackend
...
def _dsv4_block_sizes():
    ...
    from vllm_fl.dispatch.backends.vendor.ascend.models.dsa_layer import DSV4_BLOCK_SIZES
