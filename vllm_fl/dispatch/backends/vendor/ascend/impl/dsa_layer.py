...
from vllm_fl.dispatch.backends.vendor.ascend.impl.dsa_attention import (
    DSAAttention,
)
...
def _maybe_all_gather_and_maybe_unpad_impl(
    ...
    """Apply the token-layout contract used by DSA communication paths."""
    del is_ep_comm
    try:
        get_forward_context()
...
class AscendDeepseekSparseAttention(MultiHeadLatentAttentionWrapper):
    def __init__(
        ...
        self.swa_cache_layer = AscendDeepseekV4SWACache(
