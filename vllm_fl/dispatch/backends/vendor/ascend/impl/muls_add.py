...
def ensure_muls_add_registered() -> None:
    """Register the functional fusion target once per interpreter."""
    global _REGISTERED
    if _REGISTERED or hasattr(torch.ops.vllm, "muls_add"):
        _REGISTERED = True
        return
    direct_register_custom_op(
        op_name="muls_add",
        op_func=muls_add_triton,
        fake_impl=_muls_add_fake,
        mutates_args=[],
