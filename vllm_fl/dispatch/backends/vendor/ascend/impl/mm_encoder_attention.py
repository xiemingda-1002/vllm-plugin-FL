...
class AscendMMEncoderAttention(MMEncoderAttention):
    ...
    def __init__(
        ...
        The fused path avoids materializing a
        ``[batch, heads, seq, seq]`` attention-score tensor because profile
        runs use the maximum multimodal token budget and such a tensor can be
        tens of GiB.
        """
        super().__init__(
            num_heads=num_heads,
