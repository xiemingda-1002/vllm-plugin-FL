"""Default TP linear-op selection for the FL Ascend layers.

Qwen3.6's validated TP=2 baseline delegates communication to vLLM's standard
linear classes and uses the active TP group.
"""
