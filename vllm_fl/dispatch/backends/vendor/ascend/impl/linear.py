...
from .linear_op_compat import get_parallel_op, get_replicated_op
...
def maybe_trans_nz(weight: torch.Tensor) -> torch.Tensor:
    # Current vLLM-Ascend defaults weight_nz_mode to 1, which keeps BF16/FP16
    # weights in ND format.  The migrated Qwen3.6 baseline is unquantized BF16.
    return weight
