...
def ensure_qkv_rmsnorm_rope_registered() -> None:
    """Register the regular Qwen QKV/RMSNorm/RoPE target exactly once."""
    global _REGISTERED
    if _REGISTERED or hasattr(torch.ops.vllm, "qkv_rmsnorm_rope"):
        _REGISTERED = True
        return
