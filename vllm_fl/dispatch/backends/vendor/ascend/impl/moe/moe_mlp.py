...
from .mxfp_compat import (
    FLOAT8_E8M0FNU_DTYPE,
    ensure_mxfp8_moe_available,
)
from .activation import AscendSwigluOAIAndMul, AscendSwigluStepAndMul
from vllm_fl.dispatch.backends.vendor.ascend.impl.moe.moe_runtime_args import MoEMlpComputeInput
...
def unquant_apply_mlp(
    ...
    if lora_context is not None:  # LoRA applied
        raise NotImplementedError(
            "FL Ascend rc1 MoE LoRA execution is not migrated"
        )
