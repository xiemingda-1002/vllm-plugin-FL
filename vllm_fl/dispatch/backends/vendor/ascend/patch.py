...
This registration chain installs the FL-owned Qwen3.5/Qwen3.6 Ascend path and
its required operator patches.
"""
...
def patch_mamba_utils() -> None:
    """Install the FL-local Ascend Mamba state-copy kernel."""
